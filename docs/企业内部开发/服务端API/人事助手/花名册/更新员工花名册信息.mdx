---
title: "更新员工花名册信息"
generated_at: "2025-12-02 08:53:41"
update_time: 1684292970
...
<span id="multigroup">**可重复字段组列表：**</span>
|编号|名称|
|---|---|
|1|教育经历|
|2|工作经历|
...
<span id="update_items">**更新字段说明：**</span>
|参数|必须|说明|
|---|---|---|
|fieldid|是|字段id|
...
<span id="forbidden_fields">**不支持更新字段表：**</span>
>以字段id为准
...
<span id="value_type">**字段值类型对照表：**</span>
...
<span id="value_mobile">**电话号码类型字段结构：**</span>
|参数|说明|
|---|---|
