---
title: "获取日程详情"
generated_at: "2026-09-10 05:02:36"
update_time: 1785306577
source: "https://developer.work.weixin.qq.com/document/path/101697"
---
...
| 参数        | 是否必须 | 说明      |
| ----------- | -------- | --------------------------------- |
|cal_id| 是 | 默认日历本 ID，通过「获取默认日历本 ID」接口或回调获取。 |
