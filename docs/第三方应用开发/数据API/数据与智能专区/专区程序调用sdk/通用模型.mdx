---
title: "通用模型"
generated_at: "2026-02-11 09:13:32"
update_time: 1770111462
source: "https://developer.work.weixin.qq.com/document/path/101373"
---

[TOC]

应用在专区中的程序可调用本接口传入会话内容，使用企业微信通用的大语言模型进行会话分析，目前通用的大模型有 !!#ff0000 **Hunyuan · 深度思考**!!（灰度中）、 !!#ff0000 **DeepSeek · 深度思考**!!（灰度中） 与 !!#ff0000 **Hunyuan · 快速回答**!! 三种选项。
...
|model_id|否|调用的模型id，用于区分调用的是 Hunyuan · 深度思考（灰度中）、DeepSeek · 深度思考（灰度中）还是 Hunyuan · 快速回答 模型，在管理端获取。<br>只能传入 Hunyuan · 深度思考（灰度中）、DeepSeek · 深度思考（灰度中）或者 Hunyuan · 快速回答 模型的模型id，否则会报错。<br>不填默认为 Hunyuan · 快速回答 模型|
...
![enter image description here](https://wework.qpic.cn/wwpic3az/968824_k_SdQ88lTdKuFss_1768208900/0)
