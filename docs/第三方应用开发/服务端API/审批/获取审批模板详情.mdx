---
title: "获取审批模板详情"
generated_at: "2025-12-02 10:48:50"
update_time: 1579168465
source: "https://developer.work.weixin.qq.com/document/path/92631"
---
...
|  参数   | 必须 | 说明  |
| ------------ |  ------------ |
| access_token  | 是 | 调用接口凭证。须使用第三方应用的secret获取，获取方式参考：[文档-获取access_token](https://work.weixin.qq.com/api/doc/90001/90143/90605)  |
| template_id  |  是 | 模板的唯一标识id。可在“获取审批单据详情”、“审批状态变化回调通知”中获得，也可在使用“复制/更新模板到企业”接口回调中获得。注：此id为企业内模板的实例id，非服务商后台对应模板的id |

> 第三方应用的Secret可获取对应第三方应用所添加模板的详情。
> 2.接口调用频率限制为600次/分钟。
