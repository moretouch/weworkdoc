---
title: "获取审批申请详情"
generated_at: "2025-12-02 10:48:54"
update_time: 1579183528
source: "https://developer.work.weixin.qq.com/document/path/92634"
---
...
| └ └ media_id | 节点分支审批人审批意见附件，media_id具体使用请参考：[文档-获取临时素材](https://work.weixin.qq.com/api/doc#90000/90135/90254 "获取临时素材") |
...
| └ commentid | 备注id |
| └ media_id | 备注附件id，可能有多个，media_id具体使用请参考：[文档-获取临时素材](https://work.weixin.qq.com/api/doc#90000/90135/90254 "获取临时素材") |
| process_list | 审批流程列表 |
| └ node_list | 流程节点 |
...
| └ └ └ sptime | 操作时间 |
| └ └ └ media_ids | 附件，media_id具体使用请参考：[文档-获取临时素材](https://work.weixin.qq.com/api/doc#90000/90135/90254 "获取临时素材")  |
...
|  参数   | 说明  |
| ------------ |  ------------ |
| tips_content	| 说明文字内容，可参考[获取审批模板详情](#20905) -「附7：Tips控件（说明文字控件）config说明」一节说明|
