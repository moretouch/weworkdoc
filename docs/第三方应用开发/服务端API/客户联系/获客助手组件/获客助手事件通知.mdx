---
title: "获客助手事件通知"
generated_at: "2025-12-02 10:50:06"
update_time: 1699356542
source: "https://developer.work.weixin.qq.com/document/path/99485"
---
...
参数说明：
  ...
  |LinkId|添加此用户的获客链接Id|
  |State|添加此用户时获客链接配置的customer_channel值，可用于识别添加此用户的渠道|
...
<xml>
	...
	<InfoType><![CDATA[customer_acquisition]]></InfoType>
	<TimeStamp>1403610513</TimeStamp>
	<ChangeType><![CDATA[service_balance_low]]></ChangeType>
</xml>
```
...
<xml>
	...
	<InfoType><![CDATA[customer_acquisition]]></InfoType>
	<TimeStamp>1403610513</TimeStamp>
	<ChangeType><![CDATA[service_balance_exhausted]]></ChangeType>
</xml>
```
